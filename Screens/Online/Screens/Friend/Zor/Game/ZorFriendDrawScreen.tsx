...
export default function ZorFriendDrawScreen() {
    ...
    <LinearGradient colors={["#070712", "#101035", "#171753"]} style={styles.container}>
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.title}>{t.draw || "Berabere"}</Text>
          <Text style={styles.text}>
            {t.friendDrawMessage || "Zor maç berabere bitti. İkiniz de iyi oynadınız!"}
          </Text>
