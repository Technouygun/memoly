...
export default function ZorFriendWinScreen() {
    ...
    <LinearGradient colors={["#070712", "#101035", "#171753"]} style={styles.container}>
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.title}>{t.youWon || "Kazandın!"}</Text>
          <Text style={styles.text}>
            {t.friendWonMessage || "Zor arkadaş düellosunu kazandın. Harika oynadın!"}
          </Text>
