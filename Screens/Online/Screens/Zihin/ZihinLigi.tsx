...
export default function ZihinLigi() {
  ...
  const checkCoin = async () => {
    ...
    if (coins < ENTRY_FEE) {
      Alert.alert(t.notEnoughCoinsTitle, t.mindGeniusNeedCoins);
      return false;
    }
  ...
  const getMyNickname = async () => {
    ...
    try {
      ...
      return user.displayName || user.email?.split("@")?.[0] || "Oyuncu";
    }
  };
    ...
    <LinearGradient colors={["#070712", "#101035", "#171753"]} style={styles.container}>
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subLogo}>MIND MATCHMAKING</Text>
        </View>

        <View style={styles.heroCard}>
          <View style={styles.iconBadge}>
            <Icon name="brain" size={42} color="#A78BFA" />
          </View>

          <Text style={styles.title}>{t.mindGeniusTitle}</Text>
          <Text style={styles.subtitle}>
            6x8 zihin arenasında rakibini bul ve büyük ödül için savaş.
          </Text>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statBox}>
              ...
              <Text style={styles.statValue}>6x8</Text>
            </View>
          </View>
        </View>
